...
const Footer = () => {
  ...
  return (
    <footer className="border-t bg-linear-to-b from-white to-gray-50">
      <div className="custom-container py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-5">
          <div className="lg:col-span-1">
            <Logo />
            <p className="mt-4 text-sm text-muted-foreground">
              Create and share amazing blog posts with the world.
            </p>
            <div className="mt-6 flex gap-4">
              <a
                href="#"
                className="text-muted-foreground transition-colors duration-200 hover:text-primary-600"
                aria-label="Twitter"
              >
